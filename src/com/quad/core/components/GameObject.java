...
public abstract class GameObject {
	...
	public Rectangle getRectangle() {
		return new Rectangle((int) ((x) - cwidth / 2), (int) ((y) - cheight / 2) + coffy, cwidth, cheight);
	}
...
//			}
	...
	public boolean notOnScreen() {
		return x + xmap + width < 0 || x + xmap - width > GameContainer.width || y + ymap + height < 0
	...
	public void renderComponents(GameContainer gc, Renderer r) {
		...
		if (facingRight) {
			r.drawImage(animation.getImage(), (int) (x + xmap - width / 2), (int) (y + ymap - height / 2), width,
					height);
		} else {
			r.drawImageReverted(animation.getImage(), (int) (x + xmap - width / 2 + width),
	...
	public void setMovement(boolean b) {
		movement = b;
		if (!b)
			left = right = jumping = falling = false;
	}
