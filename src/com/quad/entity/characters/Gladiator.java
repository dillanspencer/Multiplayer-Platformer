...
public class Gladiator extends GamePlayer {
	...
	private final int[] NUMFRAMES = { 5, 8, 6, 7, 6 };
	private final int[] SPRITEDELAYS = { 8, 5, 5, 5, 5 };
	...
	public Gladiator(TileMap tm) {
		...
		try {
			...
			Image spritesheet = new Image("/player/Gladiator.png");
